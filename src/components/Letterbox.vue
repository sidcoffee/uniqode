<template>
  ...
  <div class="wrapper" :class="isAllTrue ? 'alltrue' : ''">
    <input data-index="0" ref="input-0" type="text"  @input="focusNextOncePopulated($event, 1)" :class="[isAddClassgreenone ? 'greenback' : '', isAddClassredone ? 'redback' : '', isAddClassyellowone ? 'yellowback': '', isAllTrue ? 'alltrue' : '']" v-if="allfalse" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
    <input data-index="1" ref="input-1" type="text"  @input="focusNextOncePopulated($event, 1)" :class="[isAddClassgreentwo ? 'greenback' : '', isAddClassredtwo ? 'redback' : '', isAddClassyellowtwo ? 'yellowback': '', isAllTrue ? 'alltrue' : '']" v-if="allfalse" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
    <input data-index="2" ref="input-2" type="text"  @input="focusNextOncePopulated($event, 1)" :class="[isAddClassgreenthree ? 'greenback' : '', isAddClassredthree ? 'redback' : '',isAddClassyellowthree ? 'yellowback': '', isAllTrue ? 'alltrue' : '']" v-if="allfalse" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
    <input data-index="3" ref="input-3" type="text"  @input="focusNextOncePopulated($event, 1)" :class="[isAddClassgreenfour ? 'greenback' : '', isAddClassredfour ? 'redback' : '',isAddClassyellowfour ? 'yellowback': '', isAllTrue ? 'alltrue' : '']" v-if="allfalse" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"/>
    <input data-index="4" ref="input-4" type="text"  @input="focusNextOncePopulated($event, 1)" maxlength="1" :class="[isAddClassgreenfive ? 'greenback' : '', isAddClassredfive ? 'redback' : '',isAddClassyellowfive ? 'yellowback': '', isAllTrue ? 'alltrue' : '']" v-if="allfalse" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"  @keyup.enter="checkval()"/>
